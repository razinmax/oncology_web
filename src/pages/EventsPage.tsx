...
import {ArticleHeader, MainSection} from "./mainPage.tsx";
...
const defaultEvents: Event[] = [
    ...
    {
        title: '80-летие Победы — хороший повод вспомнить историю семьи и страны...\n\nДорогие друзья...',
...
export const EventsPage = () => {
        ...
        (async () => {
            try {
                ...
                if (response && response.length > 0) {
                    ...
                    setEvents(defaultEvents); // fallback
                }
            } catch (e) {
                console.error("Ошибка загрузки событий:", e);
                setEvents(defaultEvents); // fallback при ошибке
            }
        })();
    }, []);
    ...
    return (
        <MainSection style={{gap: '25px', maxWidth: '1100px', margin: '0 auto', width: '100%'}}>
            <ArticleHeader>Все события</ArticleHeader>
